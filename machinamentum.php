...
<a href="mechgripper.php">
  <div class="button-fill grey">
    <div class="button-text">Mechgripper</div>
    <div class="button-inside">
      <div class="inside-text">Mechgripper</div>
    </div>
  </div>
</a>
...
<a href="madcad.php">
  <div class="button-fill grey">
    <div class="button-text">MAD 4 CAD</div>
    <div class="button-inside">
      <div class="inside-text">MAD&nbsp;4&nbsp;CAD</div>
    </div>
  </div>
</a>

<a href="contraption.php">
  <div class="button-fill grey">
    <div class="button-text">CONTRAPTION</div>
    <div class="button-inside">
      <div class="inside-text">CONTRAPTION</div>
    </div>
  </div>
</a>
...
<a href="hydrobot.php">
  <div class="button-fill grey">
    <div class="button-text">MECHANICAL&nbsp;HYDROBOT</div>
    <div class="button-inside">
      <div class="inside-text">MECHANICAL&nbsp;HYDROBOT</div>
    </div>
  </div>
</a>
...
<a href="aqua.php">
  <div class="button-fill grey">
    <div class="button-text">AQUA-CRANE</div>
    <div class="button-inside">
      <div class="inside-text">AQUA-CRANE</div>
    </div>
  </div>
</a>
...
<a href="safari.php">
  <div class="button-fill grey">
    <div class="button-text">MECH SAFARI</div>
    <div class="button-inside">
      <div class="inside-text">MECH&nbsp;SAFARI</div>
    </div>
  </div>
</a>
