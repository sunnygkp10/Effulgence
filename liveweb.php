...
<div class="row">
	...
	<div class="col-md-7">
	<div class="area1">
	<h3><b>Live Website Design</b></h3>
	</div>
	<!--scoll area start-->
<div class="area mCustomScrollbar" data-mcs-theme="light" data-mcs-axis="y">

<p>
Live website Designing is a venture of i2 technologies. It is one of the most interactive and knowledge imparting workshop in which students will learn how to design a website in stipulated duration of time and in an efficient manner.<br />
For contents click her- poster.jpg<br />
Cost of this workshop is Rs.1000 per participant.<br />
</p>	</div>
	<hr >
	</div>
	<!--scroll area end-->
	...
	<?php $eid='lwd';include_once "reg_inc.php";?>
	</div>
