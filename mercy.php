...
<p>
					  In this event, participants will get 5 questions.<br /><br />

         Participants have to write the codes for that problem in given <br /><br />

          environment where following keys will not work that are<br /><br />
          Backspace<br />
          Del<br />
         Home<br />
         End<br />
<br />
         Once you make mistake while coding you cannot change the code.
				<br />	
										
<b>  Rules :</b><br>
1. There will be two rounds: Preliminary and Mains <br>
2.  Each team must have 2 members.<br>
3. The editor will have backspace, shift and other editable keys disabled.<br>
4. You can reset your work but it will cost you few points.<br>
5. Successful completion of the task will result in few credits which will be added to your overall score.<br><br>
<b>For queries mail us at <a href="#">effulgence.nmc@hotmail.com</a> or contact<br> 
Avishkar Verma 9648850041<br>
Sulabh Singh 8896700606</b>
</p>
	...
	<?php $eid='nmc';include_once "reg_inc.php";?>
	</div>
