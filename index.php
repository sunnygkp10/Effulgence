...
echo '<a href="log.php"><button class="sunny" style="float:right">login</button></a><a href="registers.php"><button class="sunny" style="float:right">signup</button></a><a href="http://www.ticketinvert.com/events/Event.php?eventid=25145"><button class="sunny" style="float:right;font-size:12px">ALUMNI Contribution</button></a>';
}
else
{
$u_id = $_SESSION['u_id'];
...
echo '<a href="logout.php"><button class="sunny pull-right" style="position:relative">logout</button></a><b><span class="pull-right sny" >Hello,  <a href="user_profile.php">'.$name.'</a></b></span><a href="http://www.ticketinvert.com/events/Event.php?eventid=25145"><button class="sunny" style="float:right;font-size:12px">ALUMNI Contribution</button></a>';
}?>
