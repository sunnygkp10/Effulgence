...
<a href="vinci.php" >
  <div class="button-fill grey">
    <div class="button-text">DA VINCI</div>
    <div class="button-inside">
      <div class="inside-text">DA&nbsp;VINCI</div>
    </div>
  </div>
</a>
 ...
 <a href="codigo.php">
  <div class="button-fill grey">
    <div class="button-text">Codigo</div>
    <div class="button-inside">
      <div class="inside-text">codigo</div>
    </div>
  </div>
 </a>
 ...
 <a href="windows.php">
  <div class="button-fill grey">
    <div class="button-text">Windows Piratage</div>
    <div class="button-inside">
      <div class="inside-text">Windows&nbsp;Piratage</div>
    </div>
  </div>
 </a>
 ...
 <a href="app.php">
  <div class="button-fill grey">
    <div class="button-text">App development</div>
    <div class="button-inside">
      <div class="inside-text">App&nbsp;development</div>
    </div>
  </div>
 </a>
 ...
 <a href="chamber.php">
  <div class="button-fill grey">
    <div class="button-text">puzzling Chamber</div>
    <div class="button-inside">
      <div class="inside-text">puzzling&nbsp;Chamber</div>
    </div>
  </div>
 </a>
  
  <a href="Defraggler.php">
  <div class="button-fill grey">
    <div class="button-text">Code Defraggler</div>
    <div class="button-inside">
      <div class="inside-text">Code&nbsp;Defraggler</div>
    </div>
  </div>
  </a>
  ...
  <a href="mercy.php">
  <div class="button-fill grey">
    <div class="button-text">No mercy coding</div>
    <div class="button-inside">
      <div class="inside-text">No&nbsp;mercy&nbsp;coding</div>
    </div>
  </div>
  </a>
  <a href="debug.php">
  <div class="button-fill grey">
    <div class="button-text">Debugging</div>
    <div class="button-inside">
      <div class="inside-text">Debugging</div>
    </div>
  </div>
  </a>
  <a href="triangle.php">
  <div class="button-fill grey">
    <div class="button-text">code triangle</div>
    <div class="button-inside">
      <div class="inside-text">code&nbsp;triangle</div>
    </div>
  </div>
  </a>	
  ...
  <a href="cyber.php">
  <div class="button-fill grey">
    <div class="button-text">cyber quiz</div>
    <div class="button-inside">
      <div class="inside-text">cyber&nbsp;quiz</div>
    </div>
  </div>
  </a></div><hr>
	<!--scroll area end-->
