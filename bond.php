...
<div class="row">
	...
	<div class="col-md-7">
	<div class="area1">
	<h3><b>BOND WITH THE BEST</b></h3>
	</div>
	<!--scoll area start-->
<div class="area mCustomScrollbar" data-mcs-theme="light" data-mcs-axis="y">


<p>"Manufacturing is more than just putting parts together. It's coming up with ideas, testing principles and perfecting the                     engineering, as well as final assembly" <b>-James Dyson</b></p><br>

					<p><b><u>INTRODUCTION:</u></b>
                   Building construction is an ancient human activity.   It began with   the purely functional need for a controlled environment to                     moderate the effect of climate .The  history  of  building is  marked by a   number  of trends as  well as durable material had                   been found such like clay stone and timber and finally synthetic materials such as bricks ,concrete ,metal and plastics.<br><br>
                  Building construction today is a significant part of industrial culture, a manifestation of its diversity and complexity and a                  measure of its mastery of natural forces, which produce a widely varied built environment to serve the diverse need of society.                 Construction of building mainly consist of proper arrangement of bricks, stone with appropriate adhesion like surkhi ,mortar ,lime                  mortar ,cement mortar etc.<br><br>
                  Brick machinery is made of brick units bonded together with mortar. Bond is the interlacement of brick, formed lay those immediately                  below or above them. Here we provide you a plate form to showcase your creativity, knowledge and ability to deal with practical                  problems.</p>
                <p><b>EVENT DISCRIPTION</b>(<a href="pdf/Bondwiththebest.pdf">Click Here</a>)</p>
	...
	<?php $eid='bwb';include_once "reg_inc.php";?>
	</div>
