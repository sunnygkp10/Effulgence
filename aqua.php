...
<p>				"Many a little, make mickle."<br>	</p><img src="img/machinamentum5.PNG" /><br><br>
					<p><b>PROBLEM STATEMENT</b><br><br>

                    To design and fabricate a hydraulically actuated mechanical arm, which can pick up cups and wooden blocks and place them on the                       staging area in the correct order to form the given word and a pattern respectively, in the shortest possible time.<br />
 <br />

                    <b>Event Description:</b>
<br />
                   This event will be divided into two stages.<br>
                   <b>Stage I :</b> will comprise of a task of arranging jumbled letters on cups to make a correct word.<br>
                   <b>Stage II :</b> is about your imagination in which you have to form a pattern out of wooden blocks.
				   <br /><br /></p>
				   <p><b>EVENT DISCRIPTION</b>(<a href="pdf/AQUA.pdf">Click Here</a>)</p>
	...
	<?php $eid='acr';include_once "reg_inc.php";?>
	</div>
