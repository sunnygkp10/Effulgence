...
<a href="namo.php">
  <div class="button-fill grey">
    <div class="button-text">Namo the genius</div>
    <div class="button-inside">
      <div class="inside-text">namo&nbsp;the&nbsp;genius</div>
    </div>
  </div>

<a href="tempus.php">
  <div class="button-fill grey">
    <div class="button-text">tempus ride</div>
    <div class="button-inside">
      <div class="inside-text">tempus&nbsp;ride</div>
    </div>
  </div>

<a href="mania.php">
  <div class="button-fill grey">
    <div class="button-text">marketing mania</div>
    <div class="button-inside">
      <div class="inside-text">marketing&nbsp;mania</div>
    </div>
  </div>

<a href="biz.php">
  <div class="button-fill grey">
    <div class="button-text">Biz Quiz</div>
    <div class="button-inside">
      <div class="inside-text">Biz&nbsp;Quiz</div>
    </div>
  </div>
 </div><hr>
	<!--scroll area end-->
