...
<div class="row">
	...
	<div class="col-md-7">
	<div class="area1">
	<h3><b>SUSPENDO BRUCKE</b></h3>
	</div>
	<!--scoll area start-->
<div class="area mCustomScrollbar" data-mcs-theme="light" data-mcs-axis="y">
                     <p>&ldquo;Good composition is like a suspension bridge &ndash; each line adds strength and takes none away.&rdquo; <b>-Robert Henry</br></br> Introduction:-</b> A great bridge is a great monument which should serve to make known the splendour and genius of a nation, one should not occupy oneself with efforts to perfect it architecturally, for taste is always susceptible to change, but to conserve always in its form and decoration the character of solidity which is proper. We are now giving you a precious opportunity to show your Endeavour, to build the prototype of your imagination, to think outside the box of academics.&ldquo;Challenges are high, The Dreams are new, Effulgence out here is waiting for you. Dare to dream , Dare to try. No goal is too distant, No star is too high.&rdquo;</p>


					 </p><p><b>EVENT DISCRIPTION</b>(<a href="pdf/suspendo.pdf">Click Here</a>)</p>
	...
	<?php $eid='sus';include_once "reg_inc.php";?>
	</div>
