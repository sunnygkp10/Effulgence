...
<p>Find out if Internet debates and technologies are all geek or all Greek to you. Answer questions related to cyber-space, security, and current technologies and win a chance to stand out among other nerds.</p>
<b>RULES</b><br>

1. Cyber quiz is a team event comprising of 2 member teams.<br>
2. Candidates will be given a question paper comprising of 30 questions covering various topics such as technology, cyber security, current affairs in IT, general computer facts, etc.<br>
3. The duration of the quiz is 40 minutes.<br>
4. The marks distribution for the question paper will be (+1, -0.25) and (+2, -0).<br>
5.The answers to the quiz will be available right after the quiz concludes.<br>
6. Send your queries to <a href="#">effulgenceappdev@outlook.com</a> or contact-<br>
Nitish Tripathi (9451842485)<br> 
Irfan Ahmad    (8005381618)<br>
	...
	<?php $eid='cqu';include_once "reg_inc.php";?>
	</div>
