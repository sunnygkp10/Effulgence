...
<head>
<meta charset="utf-8">
<title>EFFULGENCE'15 | WORKSHOPS</title> 
...
<a href="hack.php">
  <div class="button-fill grey">
    <div class="button-text">Ethical Hacking</div>
    <div class="button-inside">
      <div class="inside-text">Ethical&nbsp;Hacking</div>
    </div>
  </div>
 </a>
...
<a href="liveweb.php">
  <div class="button-fill grey">
    <div class="button-text">Live&nbsp;website&nbsp;design</div>
    <div class="button-inside">
      <div class="inside-text">Live&nbsp;website&nbsp;design</div>
    </div>
  </div>
 </a>
...
<a href="astro.php">
  <div class="button-fill grey">
    <div class="button-text">Astronomy</div>
    <div class="button-inside">
      <div class="inside-text">Astronomy</div>
    </div>
  </div>
 </a>
...
<a href="pcb.php">
  <div class="button-fill grey">
    <div class="button-text">PCB Designing</div>
    <div class="button-inside">
      <div class="inside-text">PCB&nbsp;Designing</div>
    </div>
  </div>
 </a>

<a href="matlab.php" class="md-trigger" data-modal="#">
  <div class="button-fill grey">
    <div class="button-text">Matlab</div>
    <div class="button-inside">
      <div class="inside-text">Matlab</div>
    </div>
  </div>
 </a>
...
<a href="trans.php">
  <div class="button-fill grey">
    <div class="button-text">Transportation Engineering</div>
    <div class="button-inside">
      <div class="inside-text">Transportation&nbsp;Engineering</div>
    </div>
  </div>
 </a>
