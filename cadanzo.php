...
<div class="area mCustomScrollbar" data-mcs-theme="light" data-mcs-axis="y">
	...
	<p>"Talent works, genius creates"</p>
				  <p><b>INTRODUCTION:</b><br />
	<br />		"Graphic design is the paradise of individuality, eccentricity, heresy, abnormality, hobbies and humors"<br /><br />
				    AutoCAD is a computer-aided drafting software program used for creating blueprints for building, bridges and computer chips, 
                     AutoCAD is used mainly by drafters, although engineers, surveyors an -d architects may need to use the software from time to                     time.<br /><br />    
                     AutoCAD used in architecture, construction and manufacturing to assist in the preparation of blueprints and other engineering                     plans. Professionals who use AutoCAD are often referred to as drafters.<br /><br />  
                     While drafters work in a number of  specialties, the six most common specialization areas are mechanical drafting, architectural                     drafting, civil drafting, electrical drafting, electronics drafting and aeronautical drafting.<br /><br />
                     <br /></p>
					 <p><b>EVENT DISCRIPTION</b>(<a href="pdf/CADANZO.pdf">Click Here</a>)</p>
	...
	<?php $eid='cdz';include_once "reg_inc.php";?>
	</div>
