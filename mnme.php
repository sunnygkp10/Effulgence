...
<p><b>Description-</b></p>
					...
					<p>	In this event there will three participant from each team.<br>

	Members of each team will be seated in triangle/separately.<br />
	Different problem will be given to each member of team.<br />
	After 30 minutes members of same team will be shifted left, means now member A have to complete the task of  member B and Member B have to complete the task of member C ,and member c have to complete the task of member A And again after 30 minute a left shift will done.<br />
</p>
	...
	<a href="informal.php"><button class="sunny">Back</button></a>
