...
<div class="row">
	...
	<div class="col-md-7">
	<div class="area1">
	<h3><b>INCLINATUS</b></h3>
	</div>
	<!--scoll area start-->
<div class="area mCustomScrollbar" data-mcs-theme="light" data-mcs-axis="y">


<p><img src="img/concretus4.PNG"  height="200px" width="150px" style="float:right; margin:5px;"/>" There is an attraction and a charm inherent in the colossal that is not subject to ordinary theories of art ... The tower will be                   the tallest edifice ever raised by man. Will it therefore be imposing in its own way? "<br>
                                            <b>- GUSTAVE EIFFEL</b><br /><br />
				
					One of the most famous structures in the world, "THE LEANING TOWER OF PISA" has attained the present fame accidentally due to                      unfortunate incidents, but not built so by the engineers. But time has come where technology has grown to
                      the stage where structures can be planned and built this way. <br><br>

                      Effulgence brings you the challenge to make a similar structure with your own techniques and challenge the world to prove your                      mettle as a successful engineer.   <br />
                     </p>
					 </p><p><b>EVENT DISCRIPTION</b>(<a href="pdf/inclinatusproblemstatement.pdf">Click Here</a>)</p>
	...
	<?php $eid='inc';include_once "reg_inc.php";?>
	</div>
