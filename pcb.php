...
<div class="row">
	...
	<div class="col-md-7">
	<div class="area1">
	<h3><b>PCB designing</b></h3>
	</div>
	<!--scoll area start-->
<div class="area mCustomScrollbar" data-mcs-theme="light" data-mcs-axis="y">

<p>PCB designing is organized under the age of CETPA Infotech pvt. lmt. PCB designing is an art more than science and this art need to be provided in avery effective and efficient manner. The student will learn how to develop circuits and all the other fundamentals of electronics circuitoy.<br />
For more detail click here.<br />
Cost of this WORKSHOP IS RS. 550 per participant <br />
</p>
	</div>
	<hr >
	</div>
	...
	<?php $eid='pcb';include_once "reg_inc.php";?>
	</div>
