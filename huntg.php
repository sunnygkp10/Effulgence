...
<div class="row">
	...
	<div class="col-md-7">
	<div class="area1">
	<h3><b>HUNT YOUR GOAL</b></h3>
	</div>
	<!--scoll area start-->
<div class="area mCustomScrollbar" data-mcs-theme="light" data-mcs-axis="y">


<center><p><b>“Arise! Awake! And stop not until the goal is reached.”</b></p></center>
                        <p style="text-align:right"><b>- Swami Vivekananda</b></p><br />
                    <p><b>INTRODUCTION-:</b><br />
                    The real essence of a civil engineer lies in his surveying skills. So, here we are to explore out & check out your
                     Skills and accuracy. Transverse is a method in the field of surveying to establish control networks.<br /><br />
                      Transverse networks involve placing survey stations along a line or path of travel & then using the previously surveyed points                      as a Base for observing the next point.<br /><br />
					  
					 
				</p><p><b>EVENT DISCRIPTION</b>(<a href="pdf/HUNTYOURGOAL.pdf">Click Here</a>)</p>
	...
	<?php $eid='hyg';include_once "reg_inc.php";?>
	</div>
