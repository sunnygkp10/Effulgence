...
<p>
&bull;It is team event.<br /><br />
&bull;Each team will consist of 5 members.<br /><br />
&bull;Entry Fee of each team will be 500
<br /><br />
NOTE:If the team wish to stay for the entire length of the fest, then they will have to bear additional charge of INR 900(INR 100 refundable)which would include fooding and lodging for three days.
<br /><br />
For further query:<br />
Gaurav singh <br />
Rahul singh(9455421842)</p>
	</div>
	<hr >
	</div>
	<!--scroll area end-->
	<div class="col-md-1 back">
	<a href="fovea.php"><button class="sunny">Back</button></a>
	<a href="index.php"><button class="sunny">Home</button></a>
	
	<?php $eid='cst';include_once "reg_inc.php";?>
	</div>
