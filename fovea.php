...
<a href="cs.php">
  <div class="button-fill grey">
    <div class="button-text">CS 1.6</div>
    <div class="button-inside">
      <div class="inside-text">CS&nbsp;1.6</div>
    </div>
  </div>

<a href="nfs.php">
  <div class="button-fill grey">
    <div class="button-text">NFS MOST WANTED</div>
    <div class="button-inside">
      <div class="inside-text">NFS&nbsp;MOST&nbsp;WANTED</div>
    </div>
  </div>

<a href="fifa.php">
  <div class="button-fill grey">
    <div class="button-text">FIFA'12</div>
    <div class="button-inside">
      <div class="inside-text">FIFA'12</div>
    </div>
  </div>
	</div><hr>
	<!--scroll area end-->
