...
<p>
<b>RULES:</b><br><br>
1. It is a presentation based event and all the participants have to mail the abstract of their respective topics to <a href="">presentio.effulgence@gmail.com</a> latest by March 25, 2015.<br>
...
8. Topic should be non-Technical like INCREASING NUMBER OF TERROR ATTACKS, DEVELOPING COUNTRIES NEED TRADE NOT AID, POLITICS AND BUSINESS etc.<br>
...
<p><b>Download IEEE Format</b>(<a href="pdf/IEEE.pdf">Click Here</a>)</p>
	...
	<?php $eid='nts';include_once "reg_inc.php";?>
	</div>
