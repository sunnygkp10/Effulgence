...
<p>
Ethical Hacking workshop is going to be organised by one of the India&rsquo;s best hacker, Mr. Sunny Waghela. It is a two day workshop which is going to be organised during the duration of EFFULGENCE 15 i.e. 3rd-5th April.<br />
Course comprises of two levels integrated into one <br />
<a herf="#">Level 1.pdf</a><br />
<a href="#">Level 2.pdf</a><br />
Cost of the workshop is Rs.1000 per participant.<br />
</p>	</div>
	<hr >
	</div>
	<!--scroll area end-->
	...
	<?php $eid='eth';include_once "reg_inc.php";?>
	</div>
