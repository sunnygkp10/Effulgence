...
<a href="bond.php">
  <div class="button-fill grey">
    <div class="button-text">BOND WITH THE BEST</div>
    <div class="button-inside">
      <div class="inside-text">BOND&nbsp;WITH&nbsp;THE&nbsp;BEST</div>
    </div>
  </div>
</a>
...
<a href="cadanzo.php">
  <div class="button-fill grey">
    <div class="button-text"> CADANZO </div>
    <div class="button-inside">
      <div class="inside-text"> CADANZO </div>
    </div>
  </div>
</a>
...
<a href="huntg.php">
  <div class="button-fill grey">
    <div class="button-text">HUNT YOUR GOAL</div>
    <div class="button-inside">
      <div class="inside-text">HUNT&nbsp;YOUR&nbsp;GOAL</div>
    </div>
  </div>
</a>

<a href="inclinatus.php">
  <div class="button-fill grey">
    <div class="button-text">INCLINATUS</div>
    <div class="button-inside">
      <div class="inside-text">INCLINATUS</div>
    </div>
  </div>
</a>
<a href="urban.php">
  <div class="button-fill grey">
    <div class="button-text">URBANISMO</div>
    <div class="button-inside">
      <div class="inside-text">URBANISMO</div>
    </div>
  </div>
</a>
<a href="suspend.php">
  <div class="button-fill grey">
    <div class="button-text">SUSPENDO BRUCKE</div>
    <div class="button-inside">
      <div class="inside-text">SUSPENDO&nbsp;BRUCKE</div>
    </div>
  </div>
</a>
<b>CONTACTS:</b><br>
VAIBHAV SHARMA   --  07895457046, 08858295538<br>
<a href="#">effulgence.vaibhav@gmail.com</a><br><br>
DORBIE N MARAK    --      07505968674<br>
<a href="#">dorbiemarak@gmail.com</a>
