...
<p>
					The evil master GRU is again active with his evil plans and this time he wants something large,
He has ordered his minions to construct a mansion in which he could carry his evil plans.
Now they are stealing famous buildings of the world like pyramids, towers and other renounced buildings. It’s your duty to help them in constructing an evil bot so that they could create the mansion which GRU wants. 
<br><br>
<img src="img/bob.jpg"><br><br>
<b>Event details –</b>
It is an event of manual robot which could be wired or wireless. The bot should be capable of moving on rough, sandy and elevated surface. Your bot should be made in such a way that it can move in water, although it should NOT specifically an amphibian bot. The objective of the bot will be to steal the pillars, building blocks and pyramids. After stealing them it should construct the mansion for GRU.
<br><br>
<p><b>EVENT DISCRIPTION</b>(<a href="pdf/bobfinal.pdf">Click Here</a>)</p><br>
<p><b>Download Abstract</b>(<a href="pdf/bobabstract.docx">Click Here</a>)</p><br>
</p>
	...
	<?php $eid='btb';include_once "reg_inc.php";?>
	</div>
