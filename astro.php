...
<p>Astronomy is one of the most sought after fields in the current scenario. Keeping that thing in mind we present to you a separate section dedicated to the study of stars and galaxies and the complexities of dark matter and dark energies. Persons of national as well as international acclaim will come and share their knowledge on the matter.<br />
For details regarding content click here.<br />
Cost of this workshop is Rs.500 per participant.<br />
Astronomy is one of the most sought after fields in the current scenario. Keeping that thing in mind we present to you a separate section dedicated to the study of stars and galaxies and the complexities of dark matter and dark energies. Persons of national as well as international acclaim will come and share their knowledge on the matter.<br />
For details regarding content click here.<br />
Cost of this workshop is Rs.500 per participant.<br />
</p>	</div>
	<hr >
	...
	<a href="workshops.php"><button class="sunny">Back</button></a>
	<a href="index.php"><button class="sunny">Home</button></a>
	<?php $eid='ats';include_once "reg_inc.php";?>
	</div>
