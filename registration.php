...
<?php if($tmembers!=1)
{
echo '<p style="font-size:15px; color:#00FFFF"><b>NOTE:</b>Only the team leader is required to register his team and their members for an event.(Every team member must have Effulgence Reg Id),rest of the team members should not register separately.</p>';
}?>
