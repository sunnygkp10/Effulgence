...
<p>MATLAB is organized by CETPA Infotech Pvt. Limited. The course is a blend of MARLAB and Embedded systems. It will comprise of programming in MATLAB using ARDUNIO micro controllers.IT is one of the most advanced course in the industry.<br />
For more detail click here.<br />
This workshop requires a team of atleast two participants.</p>

<p>Team Members Cost per participant<br />
4 members Rs. 600<br />
3 members Rs. 750<br />
2 members Rs. 900<br />
</p>	</div>
	...
	<?php $eid='mlb';include_once "reg_inc.php";?>
	</div>
