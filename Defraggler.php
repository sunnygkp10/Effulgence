...
<p><b>Description-</b><br />
						In this event, there will be given problems with its solutions,
but solution will divided into blocks and it would be randomized.<br>
<br>

Your task is to arrange the solution in correct sequence.<br>
<br>

	You will be given fix time to solve each question. There will be no partial marking in this event.<br>
<br>
<b>RULES</b><br>
* There will two levels of game.<br>
*One will be the prelims and those selected in the prelims will be called to play the second level.<br>
* The second level will be of 1 hour.<br>
*You have to simply arrange the fragments of code in proper sequence.<br>
* The team may consist of two members.<br>
* The player will have to arrange the codes in the best possible minimum no of       moves.<br>
* The credits will be awarded on the basis of the number of moves.<br>
* Lesser the number of moves more will be the marks awarded.<br>
* At the end the player who will solve the game with the maximum credits will be declared as winner.<br><br>
<b>For queries mail us at <a href="#">pmalhotra.308@gmail.com</a> or contact 
Pranav Malhotra 8006732844</b>
	...
	<?php $eid='cdr';include_once "reg_inc.php";?>
	</div>
