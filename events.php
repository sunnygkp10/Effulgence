...
<p>
Yes, the time has come when you can prove to the world that you have it in you. No legacy is as rich as that of Competitions at Effulgence and we invite all of you to be a part of it. Get ready for the ultimate challenges awaiting you!</p>
<a href="software.php">
  <div class="button-fill grey">
    <div class="button-text">Software Corner</div>
    <div class="button-inside">
      <div class="inside-text">Software&nbsp;Corner</div>
    </div>
  </div></a>
  <a href="robotum.php">
  <div class="button-fill grey ">
    <div class="button-text">Robotum</div>
    <div class="button-inside">
      <div class="inside-text">Robotum</div>
    </div>
  </div></a>
  <a href="circuitus.php">
  <div class="button-fill grey">
    <div class="button-text">Circuitus</div>
    <div class="button-inside">
      <div class="inside-text">Circuitus</div>
    </div>
  </div></a>
  <a href="concretus.php">
  <div class="button-fill grey">
    <div class="button-text">Concretus</div>
    <div class="button-inside">
      <div class="inside-text">Concretus</div>
    </div>
  </div></a>
  <a href="machinamentum.php">
  <div class="button-fill grey">
    <div class="button-text">Machinamentum</div>
    <div class="button-inside">
      <div class="inside-text">Machinamentum</div>
    </div>
  </div></a>
  <a href="negotium.php">
  <div class="button-fill grey">
    <div class="button-text">Negotium</div>
    <div class="button-inside">
      <div class="inside-text">Negotium</div>
    </div>
  </div></a>
  
  <a href="fovea.php">
  <div class="button-fill grey">
    <div class="button-text">Fovea</div>
    <div class="button-inside">
      <div class="inside-text">Fovea</div>
    </div>
  </div></a>
 <a href="informal.php">
  <div class="button-fill grey">
    <div class="button-text">Informal events</div>
    <div class="button-inside">
      <div class="inside-text">informal&nbsp;events</div>
    </div>
  </div></a>
  <a href="presentio.php">
  <div class="button-fill grey">
    <div class="button-text">Presentio</div>
    <div class="button-inside">
      <div class="inside-text">Presentio</div>
    </div>
  </div></a>
	...
	<a href="index.php"><button class="sunny">Back</button></a>
