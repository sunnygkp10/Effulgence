...
<div class="row">
	...
	<div class="col-md-7">
	<div class="area1">
	<h3><b>THE BIZZ QUIZ</b></h3>
	</div>
	<!--scoll area start-->
<div class="area mCustomScrollbar" data-mcs-theme="light" data-mcs-axis="y">


<p> Are you trendy with the famous brands? Have you kept an eye on the famous business moves? Can you make the order out of the chaos? If yes, your hunt for the quest is stepping towards its end. Hold your seats tight and get ready to face the quizzing mania this season. KNIT presents you to the most awaited event of the season "THE BIZZ QUIZ"<br><br> <b> THE QUIZ FORMAT:</b><br> Quiz will proceed in three rounds 'PRELIMS', 'IDENTIFY THE BRAND' and 'FINAL'.<br /> <b>ROUND-1</b><br /> PRELIMS A question paper consisting of 15 questions will be catered to all the contestants. This is a written elimination round.<br /><br /><b> ROUND-2</b><br /> IDENTIFY THE BRAND The top -12 teams from the written round will be playing 'ROUND-2'.Here a set of 10 questions based specifically on the famous brands will be presented.<br /><br /><b> 
ROUND-3</b><br /> FINALS Top 4 out of the 12 teams will proceed to the final round the rules of which will be explained by the quizmaster at the venue itself.<br /><br />
<b> RULES AND REGULATIONS</b><br />
 1) Contestants in a team of 2 will be entertained. It is mandatory for the contestants of the team to be of the same college/institution.<br /><br />
  2) Once you register for the event you indicate your acceptance that the decision of the organizers and quizmaster will be final and binding and no correspondence in this regard would be entertained. <br /><br />
  3) The organizers retain the right to make any changes to the event ,its format, rules and in any matter related to this event ,at any time before or during the event.<br><br>
</p>
	</div>
	<hr >
	</div>
	...
	<?php $eid='bqz';include_once "reg_inc.php";?>
	</div>
