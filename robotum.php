...
<a  href="mine.php">
  <div class="button-fill grey">
    <div class="button-text">MINE HUNTER</div>
    <div class="button-inside">
      <div class="inside-text">MINE&nbsp;HUNTER</div>
    </div>
  </div></a>

<a href="matrix.php">
  <div class="button-fill grey">
    <div class="button-text">The Matrix </div>
    <div class="button-inside">
      <div class="inside-text">The&nbsp;Matrix </div>
    </div>
  </div></a>

<a href="robo.php">
  <div class="button-fill grey">
    <div class="button-text">Robo GP</div>
    <div class="button-inside">
      <div class="inside-text">ROBO&nbsp;GP </div>
    </div>
  </div></a>
  
  <a href="bob.php">
  <div class="button-fill grey">
    <div class="button-text">BOB THE BUILDER</div>
    <div class="button-inside">
      <div class="inside-text">BOB&nbsp;THE&nbsp;Builder</div>
    </div>
  </div></a>
